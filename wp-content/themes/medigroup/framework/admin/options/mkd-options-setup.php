...
add_action('after_setup_theme', 'medigroup_mikado_admin_map_init', 0);

function medigroup_mikado_admin_map_init() {

	do_action('medigroup_mikado_before_options_map');
	...
	do_action('medigroup_mikado_options_map');

	do_action('medigroup_mikado_after_options_map');
