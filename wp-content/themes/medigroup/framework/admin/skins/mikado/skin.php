...
class MikadoSkin extends MedigroupMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to medigroup_mikado_admin_scripts_init and medigroup_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('medigroup_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('medigroup_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('medigroup_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('medigroup_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('medigroup_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('medigroup_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            medigroup_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            medigroup_mikado_register_skin_style($styleHandle, $stylePath);
        }
	...
	public function setIcons() {
		$this->icons = array(
            ...
            'doctors' => $this->getSkinURI().'/assets/img/admin-logo-icon.png',
    ...
    public function renderOptions() {
        ...
        $tab    		= medigroup_mikado_get_admin_tab();
        $active_page 	= $medigroup_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param MedigroupMikadoAdminPage $page current page to load
...
*@param MedigroupMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(medigroup_mikado_get_theme_info_item('Name'), medigroup_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
