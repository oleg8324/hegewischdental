 ...
 */
class MedigroupMikadoSocialIconWidget extends MedigroupMikadoWidget {
	/**
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__('Mikado Social Icon Widget', 'medigroup') // Name
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			medigroup_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'        => 'textfield',
				...
				array(
					'type'        => 'dropdown',
					'title'       => esc_html__('Target', 'medigroup'),
					'name'        => 'target',
					'options'     => array(
				...
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Text Size (px)', 'medigroup'),
					'name'        => 'text_size',
					'description' => ''
				),
				array(
				...
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Hover Color', 'medigroup'),
					'name'        => 'hover_color',
					'description' => ''
				),
				array(
					'type'        => 'textfield',
					'title'       => esc_html__('Margin', 'medigroup'),
					'name'        => 'margin',
	...
	public function widget($args, $instance) {
		...
		<a class="mkd-social-icon-widget-holder" <?php echo medigroup_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php medigroup_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
