<div class="mkd-blog-holder mkd-blog-type-split-column <?php echo esc_attr($blog_classes) ?>" data-blog-type="<?php echo esc_attr($blog_type) ?>" <?php echo esc_attr(medigroup_mikado_set_blog_holder_data_params()); ?> >
    <?php
