<?php if($show_header_top) : ?>
	...
	<?php do_action('medigroup_mikado_before_header_top'); ?>

	<div class="mkd-top-bar">
		<?php if($top_bar_in_grid) : ?>
		<div class="mkd-grid">
			<?php endif; ?>
			<?php do_action('medigroup_mikado_after_header_top_html_open'); ?>
	...
	<?php do_action('medigroup_mikado_after_header_top'); ?>
