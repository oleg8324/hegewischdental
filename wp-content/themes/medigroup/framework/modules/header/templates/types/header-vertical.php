<?php do_action('medigroup_mikado_before_page_header'); ?>
	<aside class="mkd-vertical-menu-area">
		<div class="mkd-vertical-menu-area-inner">
			<div class="mkd-vertical-area-background" <?php medigroup_mikado_inline_style(array(
				$vertical_header_background_color,
				$vertical_header_opacity,
				$vertical_background_image
			)); ?>></div>
			<?php if(!$hide_logo) {
				medigroup_mikado_get_logo('vertical');
			} ?>
			<?php medigroup_mikado_get_vertical_main_menu(); ?>
