<div class="mkd-fullscreen-menu-holder-outer">
	<div class="mkd-fullscreen-menu-holder" <?php medigroup_mikado_inline_style(array($fullscreen_background_image)); ?>>
		<div class="mkd-fullscreen-menu-holder-inner">
			...
			<div class="mkd-container-inner">
				...
				//Navigation
				medigroup_mikado_get_full_screen_menu_navigation();
