<?php
namespace Medigroup\Modules\GoogleMap;
...
class GoogleMap implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name'                    => esc_html__('Google Map', 'medigroup'),
				'base'                    => $this->base,
				...
				'params'                  => array(
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Address 1', 'medigroup'),
						'param_name'  => 'address1',
						'admin_label' => true
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Address 2', 'medigroup'),
						'param_name'  => 'address2',
						'admin_label' => true,
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Address 3', 'medigroup'),
						'param_name'  => 'address3',
						'admin_label' => true,
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Address 4', 'medigroup'),
						'param_name'  => 'address4',
						'admin_label' => true,
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Address 5', 'medigroup'),
						'param_name'  => 'address5',
						'admin_label' => true,
					...
					array(
						'type'        => 'dropdown',
						'heading'     => esc_html__('Custom Map Style', 'medigroup'),
						'param_name'  => 'custom_map_style',
						'value'       => array(
							esc_html__('No', 'medigroup')  => 'false',
							esc_html__('Yes', 'medigroup') => 'true'
						),
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow Map editing', 'medigroup')
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Color Overlay', 'medigroup'),
						'param_name'  => 'color_overlay',
						'description' => esc_html__('Choose a Map color overlay', 'medigroup'),
						'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Saturation', 'medigroup'),
						'param_name'  => 'saturation',
						'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)', 'medigroup'),
						'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Lightness', 'medigroup'),
						'param_name'  => 'lightness',
						'description' => esc_html__('Choose a level of lightness (-100 = darkest, 100 = lightest)', 'medigroup'),
						'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type'        => 'attach_image',
						'heading'     => esc_html__('Pin', 'medigroup'),
						'param_name'  => 'pin',
						'description' => esc_html__('Select a pin image to be used on Google Map', 'medigroup')
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Map Zoom', 'medigroup'),
						'param_name'  => 'zoom',
						'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)', 'medigroup')
					),
					array(
						'type'        => 'dropdown',
						'heading'     => esc_html__('Zoom Map on Mouse Wheel', 'medigroup'),
						...
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel', 'medigroup')
					),
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__('Map Height', 'medigroup'),
	...
	public function render($atts, $content = null) {
		...
		$html = medigroup_mikado_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
