<?php
namespace Medigroup\Modules\Shortcodes\TabSlider;
...
class TabSlider implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                    => esc_html__('Tab Slider', 'medigroup'),
            'base'                    => $this->base,
    ...
    public function render($atts, $content = null) {
        ...
        return medigroup_mikado_get_shortcode_module_template_part('templates/tab-slider-holder', 'tab-slider', '', $params);
    }
