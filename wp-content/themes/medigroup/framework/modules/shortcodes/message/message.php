<?php
namespace Medigroup\Modules\Message;
...
class Message implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Message', 'medigroup'),
			'base'                      => $this->base,
			...
			'params'                    => array_merge(
				...
				\MedigroupMikadoIconCollections::get_instance()->getVCParamsArray(array(
					'element' => 'type',
					'value'   => 'with_icon'
				)),
				array(
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Border Width (px)', 'medigroup'),
						'param_name'  => 'border_width',
						'description' => esc_html__('Default value is 0', 'medigroup')
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color', 'medigroup'),
					...
					array(
						...
						'param_name'  => 'content',
						'value'       => '<p>'.esc_html__('I am test text for Message shortcode.', 'medigroup').'</p>',
						'description' => ''
					)
				)
			)
	...
	public function render($atts, $content = null) {
		...
		$html = medigroup_mikado_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);
