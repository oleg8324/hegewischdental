<?php
namespace Medigroup\Modules\Shortcodes\AnimationsHolder;
...
class AnimationsHolder implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                    => esc_html__('Animations Holder', 'medigroup'),
				'base'                    => $this->base,
				...
				'params'                  => array(
					array(
						'type'        => 'dropdown',
						'heading'     => esc_html__('Animation', 'medigroup'),
					...
					array(
						'type'        => 'textfield',
						'class'       => '',
						'heading'     => esc_html__('Animation Speed (ms)', 'medigroup'),
	...
	public function render($atts, $content = null) {
		...
		return medigroup_mikado_get_shortcode_module_template_part('templates/animations-holder-template', 'animations-holder', '', $params);
	}
