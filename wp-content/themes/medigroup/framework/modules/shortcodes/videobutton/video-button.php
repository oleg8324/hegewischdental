<?php
namespace Medigroup\Modules\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Video Button', 'medigroup'),
			'base'                      => $this->getBase(),
			...
			'params'                    => array(
				...
				array(
					"type"       => "textfield",
					"heading"    => esc_html__("Play Button Size (px)", 'medigroup'),
				...
				array(
					'type'        => 'dropdown',
					'admin_label' => true,
					'heading'     => esc_html__('Video Button Style', 'medigroup'),
	...
	public function render($atts, $content = null) {
		...
		$html = medigroup_mikado_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);
