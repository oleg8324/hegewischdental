<?php
namespace Medigroup\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Custom Font', 'medigroup'),
			'base'                      => $this->getBase(),
			...
			'params'                    => array(
				array(
					"type"       => "dropdown",
					"heading"    => esc_html__("Custom Font Tag", 'medigroup'),
				...
				array(
					"type"       => "textfield",
					"heading"    => esc_html__("Font family", 'medigroup'),
				...
				array(
					"type"       => "textfield",
					"heading"    => esc_html__("Line height (px)", 'medigroup'),
					"param_name" => "line_height",
					"value"      => ""
				),
				array(
					"type"        => "dropdown",
					"heading"     => esc_html__("Font Style", 'medigroup'),
					"param_name"  => "font_style",
					"value"       => medigroup_mikado_get_font_style_array(),
					"description" => ""
				),
				array(
					"type"        => "dropdown",
				...
				array(
					"type"       => "textfield",
					"heading"    => esc_html__("Letter Spacing (px)", 'medigroup'),
				...
				array(
					...
					"value"       => medigroup_mikado_get_text_transform_array(),
					"description" => ""
				),
				array(
					"type"        => "dropdown",
					"heading"     => esc_html__("Text decoration", 'medigroup'),
					"param_name"  => "text_decoration",
					"value"       => array(
						esc_html__("None", 'medigroup')         => "",
						esc_html__("Underline", 'medigroup')    => "underline",
						esc_html__("Overline", 'medigroup')     => "overline",
						esc_html__("Line Through", 'medigroup') => "line-through"
					),
					"description" => ""
				),
				array(
				...
				array(
					...
					"value"       => array(
						...
						esc_html__("Justify", 'medigroup') => "justify"
					),
					"description" => ""
				),
				array(
					...
					"value"       => esc_html__("Custom Font Content", 'medigroup'),
					"description" => "",
					"save_always" => true
				)
			)
	...
	public function render($atts, $content = null) {
		...
		$html = medigroup_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
