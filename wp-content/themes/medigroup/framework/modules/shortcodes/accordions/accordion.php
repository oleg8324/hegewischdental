<?php
namespace Medigroup\Modules\Accordion;
...
class Accordion implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                    => esc_html__('Accordion', 'medigroup'),
			'base'                    => $this->base,
			...
			'params'                  => array(
				...
				array(
					...
					'param_name'  => 'style',
					'value'       => array(
						esc_html__('Accordion', 'medigroup')       => 'accordion',
						esc_html__('Boxed Accordion', 'medigroup') => 'boxed_accordion',
						esc_html__('Toggle', 'medigroup')          => 'toggle',
						esc_html__('Boxed Toggle', 'medigroup')    => 'boxed_toggle'
					),
					'save_always' => true,
					'description' => ''
				)
	...
	public function render($atts, $content = null) {
		...
		$output .= medigroup_mikado_get_shortcode_module_template_part('templates/accordion-holder-template', 'accordions', '', $params);
