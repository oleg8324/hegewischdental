 ...
 */
?>
<div <?php mkd_core_class_attribute($holder_classes); ?> <?php echo medigroup_mikado_get_inline_attrs($data_attr); ?>>

	<div class="mkd-percentage" <?php echo medigroup_mikado_get_inline_attrs($pie_chart_data); ?>>
