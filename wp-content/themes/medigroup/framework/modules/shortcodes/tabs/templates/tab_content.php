...
?>
<div <?php medigroup_mikado_class_attribute($tab_classes); ?> <?php medigroup_mikado_inline_style($tab_styles); ?> id="tab-<?php echo sanitize_title( $tab_title )?>" <?php print $tab_data_str?>>
