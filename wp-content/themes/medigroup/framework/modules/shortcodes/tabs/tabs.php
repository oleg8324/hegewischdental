<?php
namespace Medigroup\Modules\Tabs;
...
class Tabs implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                    => esc_html__('Tabs', 'medigroup'),
			'base'                    => $this->getBase(),
			...
			'params'                  => array(
				array(
					...
					'param_name'  => 'style',
					'value'       => array(
						esc_html__('Horizontal With Text', 'medigroup')           => 'horizontal_with_text',
						esc_html__('Horizontal With Icons', 'medigroup')          => 'horizontal_with_icons',
						esc_html__('Horizontal With Text And Icons', 'medigroup') => 'horizontal_with_text_and_icons',
						esc_html__('Vertical With Text', 'medigroup')             => 'vertical_with_text',
						esc_html__('Vertical With Icons', 'medigroup')            => 'vertical_with_icons',
						esc_html__('Vertical With Text and Icons', 'medigroup')   => 'vertical_with_text_and_icons'
					),
					'save_always' => true,
					'description' => ''
				),
				array(
                    'heading'     => esc_html__('Navigation Width', 'medigroup'),
					'type'        => 'dropdown',
					'admin-label' => true,
					'param_name'  => 'navigation_width',
					'value'       => array(
						esc_html__('Medium', 'medigroup') => '',
				...
				array(
                    'heading'     => esc_html__('Animated Tabs', 'medigroup'),
                    'type'        => 'dropdown',
					'admin-label' => true,
					'param_name'  => 'animated_tabs',
					'value'       => array(
	...
	public function render($atts, $content = null) {
		...
		$output .= medigroup_mikado_get_shortcode_module_template_part('templates/'.$tabs_type, 'tabs', '', $params);
	...
	private function getTabClass($params) {
		...
		if ($params['animated_tabs'] == 'yes') {
			$tabClass .= ' mkd-animated-tabs';
		}
