...
if(!function_exists('medigroup_mikado_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function medigroup_mikado_get_wpml_pages_for_current_page() {
...
if(!function_exists('medigroup_mikado_disable_wpml_css')) {
	function medigroup_mikado_disable_wpml_css() {
		define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
	}

	add_action('after_setup_theme', 'medigroup_mikado_disable_wpml_css');
}