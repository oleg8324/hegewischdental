...
class MedigroupMikadoIconsFontElegant implements iMedigroupMikadoIconCollection {
    ...
    private function setSocialIconsArray() {
		...
		$this->socialIcons = array(
			"" => "",
			"social_blogger" => esc_html__("Blogger", 'medigroup'),
			"social_blogger_circle" => esc_html__("Blogger circle", 'medigroup'),
			"social_blogger_square" => esc_html__("Blogger square", 'medigroup'),
			"social_delicious" => esc_html__("Delicious", 'medigroup'),
			"social_delicious_circle" => esc_html__("Delicious circle", 'medigroup'),
			"social_delicious_square" => esc_html__("Delicious square", 'medigroup'),
			"social_deviantart" => esc_html__("Deviantart", 'medigroup'),
			"social_deviantart_circle" => esc_html__("Deviantart circle", 'medigroup'),
			"social_deviantart_square" => esc_html__("Deviantart square", 'medigroup'),
			"social_dribbble" => esc_html__("Dribbble", 'medigroup'),
			"social_dribbble_circle" => esc_html__("Dribbble circle", 'medigroup'),
			"social_dribbble_square" => esc_html__("Dribbble square", 'medigroup'),
			"social_facebook" => esc_html__("Facebook", 'medigroup'),
			"social_facebook_circle" => esc_html__("Facebook circle", 'medigroup'),
			"social_facebook_square" => esc_html__("Facebook square", 'medigroup'),
			"social_flickr" => esc_html__("Flickr", 'medigroup'),
			"social_flickr_circle" => esc_html__("Flickr circle", 'medigroup'),
			"social_flickr_square" => esc_html__("Flickr square", 'medigroup'),
			"social_googledrive" => esc_html__("Googledrive", 'medigroup'),
			"social_googledrive_alt2" => esc_html__("Googledrive alt2", 'medigroup'),
			"social_googledrive_square" => esc_html__("Googledrive square", 'medigroup'),
			"social_googleplus" => esc_html__("Googleplus", 'medigroup'),
			"social_googleplus_circle" => esc_html__("Googleplus circle", 'medigroup'),
			"social_googleplus_square" => esc_html__("Googleplus square", 'medigroup'),
			"social_instagram" => esc_html__("Instagram", 'medigroup'),
			"social_instagram_circle" => esc_html__("Instagram circle", 'medigroup'),
			"social_instagram_square" => esc_html__("Instagram square", 'medigroup'),
			"social_linkedin" => esc_html__("Linkedin", 'medigroup'),
			"social_linkedin_circle" => esc_html__("Linkedin circle", 'medigroup'),
			"social_linkedin_square" => esc_html__("Linkedin square", 'medigroup'),
			"social_myspace" => esc_html__("Myspace", 'medigroup'),
			"social_myspace_circle" => esc_html__("myspace circle", 'medigroup'),
			"social_myspace_square" => esc_html__("myspace square", 'medigroup'),
			"social_picassa" => esc_html__("Picassa", 'medigroup'),
			"social_picassa_circle" => esc_html__("Picassa circle", 'medigroup'),
			"social_picassa_square" => esc_html__("Picassa square", 'medigroup'),
			"social_pinterest" => esc_html__("Pinterest", 'medigroup'),
			"social_pinterest_circle" => esc_html__("Pinterest circle", 'medigroup'),
			"social_pinterest_square" => esc_html__("Pinterest square", 'medigroup'),
			"social_rss" => esc_html__("Rss", 'medigroup'),
			"social_rss_circle" => esc_html__("Rss circle", 'medigroup'),
			"social_rss_square" => esc_html__("Rss square", 'medigroup'),
			"social_share" => esc_html__("Share", 'medigroup'),
			"social_share_circle" => esc_html__("Share circle", 'medigroup'),
			"social_share_square" => esc_html__("Share square", 'medigroup'),
			"social_skype" => esc_html__("Skype", 'medigroup'),
			"social_skype_circle" => esc_html__("Skype circle", 'medigroup'),
			"social_skype_square" => esc_html__("Skype square", 'medigroup'),
			"social_spotify" => esc_html__("Spotify", 'medigroup'),
			"social_spotify_circle" => esc_html__("Spotify circle", 'medigroup'),
			"social_spotify_square" => esc_html__("Spotify square", 'medigroup'),
			"social_stumbleupon_circle" => esc_html__("Stumbleupon circle", 'medigroup'),
			"social_stumbleupon_square" => esc_html__("Stumbleupon square", 'medigroup'),
			"social_tumbleupon" => esc_html__("Stumbleupon", 'medigroup'),
			"social_tumblr" => esc_html__("Tumblr", 'medigroup'),
			"social_tumblr_circle" => esc_html__("Tumblr circle", 'medigroup'),
			"social_tumblr_square" => esc_html__("Tumblr square", 'medigroup'),
			"social_twitter" => esc_html__("Twitter", 'medigroup'),
			"social_twitter_circle" => esc_html__("Twitter circle", 'medigroup'),
			"social_twitter_square" => esc_html__("Twitter square", 'medigroup'),
			"social_vimeo" => esc_html__("Vimeo", 'medigroup'),
			"social_vimeo_circle" => esc_html__("Vimeo circle", 'medigroup'),
			"social_vimeo_square" => esc_html__("Vimeo square", 'medigroup'),
			"social_wordpress" => esc_html__("Wordpress", 'medigroup'),
			"social_wordpress_circle" => esc_html__("Wordpress circle", 'medigroup'),
			"social_wordpress_square" => esc_html__("Wordpress square", 'medigroup'),
			"social_youtube" => esc_html__("Youtube", 'medigroup'),
			"social_youtube_circle" => esc_html__("Youtube circle", 'medigroup'),
			"social_youtube_square" => esc_html__("Youtube square", 'medigroup')
		);
	}
