...
class MedigroupMikadoSimpleLineIcons implements iMedigroupMikadoIconCollection {
	...
	public function setSocialIconsArray() {
		$this->socialIcons = array(
			''                        => '',
			'icon-social-tumblr'      => esc_html__('Tumblr', 'medigroup'),
			'icon-social-twitter'     => esc_html__('Twitter', 'medigroup'),
			'icon-social-facebook'    => esc_html__('Facebook', 'medigroup'),
			'icon-social-instagram'   => esc_html__('Instagram', 'medigroup'),
			'icon-social-linkedin'    => esc_html__('LinkedIn', 'medigroup'),
			'icon-social-pintarest'   => esc_html__('Pinterest', 'medigroup'),
			'icon-social-github'      => esc_html__('Github', 'medigroup'),
			'icon-social-gplus'       => esc_html__('Google Plus', 'medigroup'),
			'icon-social-reddit'      => esc_html__('Reddit', 'medigroup'),
			'icon-social-skype'       => esc_html__('Skype', 'medigroup'),
			'icon-social-dribbble'    => esc_html__('Dribbble', 'medigroup'),
			'icon-social-behance'     => esc_html__('Behance', 'medigroup'),
			'icon-social-foursquare'  => esc_html__('Foursquare', 'medigroup'),
			'icon-social-soundcloud'  => esc_html__('Soundcloud', 'medigroup'),
			'icon-social-spotify'     => esc_html__('Spotify', 'medigroup'),
			'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'medigroup'),
			'icon-social-youtube'     => esc_html__('Youtube', 'medigroup'),
			'icon-social-dropbox'     => esc_html__('Dropbox', 'medigroup')
		);
	}
