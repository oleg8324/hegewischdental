...
/*
  Class: MedigroupMikadoIconCollections
...
class MedigroupMikadoIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection('font_awesome', new MedigroupMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
		$this->addIconCollection('font_elegant', new MedigroupMikadoIconsFontElegant("Font Elegant", "fe_icon"));
		$this->addIconCollection('ion_icons', new MedigroupMikadoIonIcons("Ion Icons", "ion_icon"));
		$this->addIconCollection('linea_icons', new MedigroupMikadoLineaIcons('Linea Icons', 'linea_icon'));
		$this->addIconCollection('linear_icons', new MedigroupMikadoLinearIcons('Linear Icons', 'linear_icon'));
		$this->addIconCollection('simple_line_icons', new MedigroupMikadoSimpleLineIcons('Simple Line Icons',
			'simple_line_icons'));
		$this->addIconCollection('dripicons', new MedigroupMikadoDripicons('Dripicons', 'dripicon'));
	}
	...
	public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = '', $emptyIconPack = false) {
		...
		$iconPackParams = array(
			'type'        => 'dropdown',
			'heading'     => esc_html__('Icon Pack', 'medigroup'),
		...
		if(is_array($this->iconCollections) && count($this->iconCollections)) {
			foreach($this->iconCollections as $key => $collection) {
				$iconSetParams[] = array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Icon', 'medigroup'),
	...
	public function getWidgetIconParams() {
		...
		$iconPackParams[] = array(
			'type'    => 'dropdown',
			'title'   => esc_html__('Icon Pack', 'medigroup'),
			'name'    => 'icon_pack',
			'options' => array(
		...
		if(is_array($iconCollections) && count($iconCollections)) {
			foreach($iconCollections as $key => $collection) {
				$iconSetParams[] = array(
					'type'    => 'dropdown',
					'title'   => $collection->title.esc_html__(' Icon', 'medigroup'),
	...
	public function getIconCollectionIcons(iMedigroupMikadoIconCollection $collection) {
...
$medigroup_IconCollections = MedigroupMikadoIconCollections::get_instance();