...
class MedigroupMikadoIonIcons implements iMedigroupMikadoIconCollection {
	...
	private function setSocialIconsArray() {
		...
		$this->socialIcons = array(
			'' => '',
			'ion-social-android' => esc_html__('Android', 'medigroup'),
			'ion-social-android-outline' => esc_html__('Android outline', 'medigroup'),
			'ion-social-angular' => esc_html__('Angular', 'medigroup'),
			'ion-social-angular-outline' => esc_html__('Angular outline', 'medigroup'),
			'ion-social-apple' => esc_html__('Apple', 'medigroup'),
			'ion-social-apple-outline' => esc_html__('Apple outline', 'medigroup'),
			'ion-social-bitcoin' => esc_html__('Bitcoin', 'medigroup'),
			'ion-social-bitcoin-outline' => esc_html__('Bitcoin outline', 'medigroup'),
			'ion-social-buffer' => esc_html__('Buffer', 'medigroup'),
			'ion-social-buffer-outline' => esc_html__('Buffer outline', 'medigroup'),
			'ion-social-chrome' => esc_html__('Chrome', 'medigroup'),
			'ion-social-chrome-outline' => esc_html__('Chrome outline', 'medigroup'),
			'ion-social-codepen' => esc_html__('Codepen', 'medigroup'),
			'ion-social-codepen-outline' => esc_html__('Codepen outline', 'medigroup'),
			'ion-social-css3' => esc_html__('CSS3', 'medigroup'),
			'ion-social-css3-outline' => esc_html__('CSS3 outline', 'medigroup'),
			'ion-social-designernews' => esc_html__('Designernews', 'medigroup'),
			'ion-social-designernews-outline' => esc_html__('Designernews outline', 'medigroup'),
			'ion-social-dribbble' => esc_html__('Dribbble', 'medigroup'),
			'ion-social-dribbble-outline' => esc_html__('Dribbble outline', 'medigroup'),
			'ion-social-dropbox' => esc_html__('Dropbox', 'medigroup'),
			'ion-social-dropbox-outline' => esc_html__('Dropbox outline', 'medigroup'),
			'ion-social-euro' => esc_html__('Euro', 'medigroup'),
			'ion-social-euro-outline' => esc_html__('Euro outline', 'medigroup'),
			'ion-social-facebook' => esc_html__('Facebook', 'medigroup'),
			'ion-social-facebook-outline' => esc_html__('Facebook outline', 'medigroup'),
			'ion-social-foursquare' => esc_html__('Foursquare', 'medigroup'),
			'ion-social-foursquare-outline' => esc_html__('Foursquare outline', 'medigroup'),
			'ion-social-freebsd-devil' => esc_html__('Freebsd devil', 'medigroup'),
			'ion-social-github' => esc_html__('Github', 'medigroup'),
			'ion-social-github-outline' => esc_html__('Github outline', 'medigroup'),
			'ion-social-google' => esc_html__('Google', 'medigroup'),
			'ion-social-google-outline' => esc_html__('Google outline', 'medigroup'),
			'ion-social-googleplus' => esc_html__('Google plus', 'medigroup'),
			'ion-social-googleplus-outline' => esc_html__('Google plus outline', 'medigroup'),
			'ion-social-hackernews' => esc_html__('Hackernews', 'medigroup'),
			'ion-social-hackernews-outline' => esc_html__('Hackernews outline', 'medigroup'),
			'ion-social-html5' => esc_html__('HTML5', 'medigroup'),
			'ion-social-html5-outline' => esc_html__('HTML5 outline', 'medigroup'),
			'ion-social-instagram' => esc_html__('Instagram', 'medigroup'),
			'ion-social-instagram-outline' => esc_html__('Instagram outline', 'medigroup'),
			'ion-social-javascript' => esc_html__('Java Script', 'medigroup'),
			'ion-social-javascript-outline' => esc_html__('Java Script outline', 'medigroup'),
			'ion-social-linkedin' => esc_html__('Linkedin', 'medigroup'),
			'ion-social-linkedin-outline' => esc_html__('Linkedin outline', 'medigroup'),
			'ion-social-markdown' => esc_html__('Markdown', 'medigroup'),
			'ion-social-nodejs' => esc_html__('Node.js', 'medigroup'),
			'ion-social-octocat' => esc_html__('Octocat', 'medigroup'),
			'ion-social-pinterest' => esc_html__('Pinterest', 'medigroup'),
			'ion-social-pinterest-outline' => esc_html__('Pinterest outline', 'medigroup'),
			'ion-social-python' => esc_html__('Python', 'medigroup'),
			'ion-social-reddit' => esc_html__('Reddit', 'medigroup'),
			'ion-social-reddit-outline' => esc_html__('Reddit outline', 'medigroup'),
			'ion-social-rss' => esc_html__('RSS', 'medigroup'),
			'ion-social-rss-outline' => esc_html__('RSS outline', 'medigroup'),
			'ion-social-sass' => esc_html__('sass', 'medigroup'),
			'ion-social-skype' => esc_html__('Skype', 'medigroup'),
			'ion-social-skype-outline' => esc_html__('Skype outline', 'medigroup'),
			'ion-social-snapchat' => esc_html__('Snapchat', 'medigroup'),
			'ion-social-snapchat-outline' => esc_html__('Snapchat outline', 'medigroup'),
			'ion-social-tumblr' => esc_html__('Tumblr', 'medigroup'),
			'ion-social-tumblr-outline' => esc_html__('Tumblr outline', 'medigroup'),
			'ion-social-tux' => esc_html__('Tux', 'medigroup'),
			'ion-social-twitch' => esc_html__('Twitch', 'medigroup'),
			'ion-social-twitch-outline' => esc_html__('Twitch outline', 'medigroup'),
			'ion-social-twitter' => esc_html__('Twitter', 'medigroup'),
			'ion-social-twitter-outline' => esc_html__('Twitter outline', 'medigroup'),
			'ion-social-usd' => esc_html__('USD', 'medigroup'),
			'ion-social-usd-outline' => esc_html__('USD outline', 'medigroup'),
			'ion-social-vimeo' => esc_html__('Vimeo', 'medigroup'),
			'ion-social-vimeo-outline' => esc_html__('Vimeo outline', 'medigroup'),
			'ion-social-whatsapp' => esc_html__('Whatsapp', 'medigroup'),
			'ion-social-whatsapp-outline' => esc_html__('Whatsapp outline', 'medigroup'),
			'ion-social-windows' => esc_html__('Windows', 'medigroup'),
			'ion-social-windows-outline' => esc_html__('Windows outline', 'medigroup'),
			'ion-social-wordpress' => esc_html__('Wordpress', 'medigroup'),
			'ion-social-wordpress-outline' => esc_html__('Wordpress outline', 'medigroup'),
			'ion-social-yahoo' => esc_html__('Yahoo', 'medigroup'),
			'ion-social-yahoo-outline' => esc_html__('Yahoo outline', 'medigroup'),
			'ion-social-yen' => esc_html__('Yen', 'medigroup'),
			'ion-social-yen-outline' => esc_html__('Yen outline', 'medigroup'),
			'ion-social-youtube' => esc_html__('Youtube', 'medigroup'),
			'ion-social-youtube-outline' => esc_html__('Youtube outline', 'medigroup')
		);
	}
