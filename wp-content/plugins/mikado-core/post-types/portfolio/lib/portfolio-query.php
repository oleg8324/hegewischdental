...
class PortfolioQuery {
	...
	public function queryVCParams() {
		return array(
			...
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__('One-Category Portfolio List', 'mkd_core'),
				'param_name'  => 'category',
				'value'       => '',
				'admin_label' => true,
				'description' => esc_html__('Enter one category slug (leave empty for showing all categories)', 'mkd_core'),
				'group'       => esc_html__('Query Options', 'mkd_core')
			),
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__('Number of Portfolios Per Page', 'mkd_core'),
				'param_name'  => 'number',
				'value'       => '-1',
				'admin_label' => true,
				'description' => esc_html__('(Enter -1 to show all)', 'mkd_core'),
				'group'       => esc_html__('Query Options', 'mkd_core')
			),
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__('Show Only Projects with Listed IDs', 'mkd_core'),
