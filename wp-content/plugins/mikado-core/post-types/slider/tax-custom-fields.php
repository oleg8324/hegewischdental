...
function mkd_slides_category_taxonomy_custom_fields($tag) {
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Anchor', 'mkd_core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Effect on header (dark/light style)', 'mkd_core'); ?></label>
		</th>
		<td>
			<select name="term_meta[header_effect]" id="term_meta[header_effect]">
				<option <?php if($term_meta['header_effect'] == 'no') {
					echo "selected='selected'";
				} ?> value="no"><?php esc_html_e('No', 'mkd_core'); ?></option>
				<option <?php if($term_meta['header_effect'] == 'yes') {
					echo "selected='selected'";
				} ?> value="yes"><?php esc_html_e('Yes', 'mkd_core'); ?></option>
			</select>
		</td>
	</tr>
	<!--    <tr class="form-field">-->
	<!--        <th scope="row" valign="top">-->
	<!--            <label for="shortcode">--><?php //esc_html_e('Show prev/next thumbs (except for side menu or passepartout)', 'mkd_core'); ?><!--</label>-->
	<!--        </th>-->
	<!--        <td>-->
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Show slide number', 'mkd_core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Parallax effect', 'mkd_core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Time between slide transitions in milliseconds', 'mkd_core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Slider height in px', 'mkd_core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Responsive height', 'mkd_core'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 1 (values: 0-1, default value: 1)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Title', 'mkd_core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Subtitle', 'mkd_core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Text', 'mkd_core'); ?></label>
			...
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Button', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width > 1600px for 'set1' and 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 2 (values: 0-1, default value: 1)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width = [1200px,1600px] for 'set1', screen width = [1300px,1600px] for 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 3 (values: 0-1, default value: 0.8)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width = [900px,1200px] for 'set1', screen width = [1000px,1300px] for 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 4 (values: 0-1, default value: 0.7)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width = [650px,900px] for 'set1', screen width = [768px,1000px] for 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 5 (values: 0-1, default value: 0.6)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width = [500px,650px] for 'set1', screen width = [567px,768px] for 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 6 (values: 0-1, default value: 0.5)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width = [320px,500px] for 'set1', screen width = [320px,567px] for 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field slider-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Breakpoint Coefficients 7 (values: 0-1, default value: 0.4)', 'mkd_core'); ?></label>
		</th>
		<td>
			<div class="inline">
				<label for="shortcode"><?php esc_html_e('Graphic', 'mkd_core'); ?></label>
			...
			<br/>
			<br/>
			<span class="description"><?php esc_html_e("screen width < 320px for 'set1' and 'set2'", 'mkd_core'); ?></span>
		</td>
	</tr>
	<tr class="form-field">
		<th scope="row" valign="top">
			<label for="shortcode"><?php esc_html_e('Slider shortcode', 'mkd_core'); ?></label>
		</th>
		<td>
			...
			<span class="description"><?php esc_html_e('Use this shortcode to insert it on page', 'mkd_core'); ?></span>
		</td>
	</tr>
...
function mkd_theme_columns($theme_columns) {
	$new_columns = array(
		...
		'name'      => esc_html__('Name', 'mkd_core'),
		'shortcode' => esc_html__('Shortcode', 'mkd_core'),
		'slug'      => esc_html__('Slug', 'mkd_core'),
		'posts'     => esc_html__('Posts', 'mkd_core')
	);
