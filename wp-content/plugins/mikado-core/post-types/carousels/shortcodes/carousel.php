...
class Carousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Carousel', 'mkd_core'),
			'base'                      => $this->base,
			...
			'params'                    => array(
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Carousel Slider', 'mkd_core'),
					'param_name'  => 'carousel',
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Number of items showing', 'mkd_core'),
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Image Animation', 'mkd_core'),
					'param_name'  => 'image_animation',
					'value'       => array(
						esc_html__('Image Change', 'mkd_core') => 'image-change',
						esc_html__('Image Zoom', 'mkd_core')   => 'image-zoom'
					),
					'admin_label' => true,
					'save_always' => true,
					'description' => esc_html__('Note: Only on "Image Change" zoom image will be used', 'mkd_core')
				),
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Show navigation?', 'mkd_core'),
				...
				array(
					...
					"holder"      => "div",
					"class"       => "",
					"heading"     => esc_html__("Number of Rows", 'mkd_core'),
				...
				array(
					'type'        => 'dropdown',
					'heading'     => esc_html__('Enable border between items', 'mkd_core'),
					'param_name'  => 'border',
					'value'       => array(
						esc_html__('No', 'mkd_core')  => 'no',
						esc_html__('Yes', 'mkd_core') => 'yes',
