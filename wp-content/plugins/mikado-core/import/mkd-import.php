...
class MedigroupMikadoImport {
    ...
    function MedigroupMikadoImport() {
    ...
    public function import_content($file){
        if (!class_exists('WP_Importer')) {
            ...
            $this->message = esc_html__("Error loading files", "medigroup");
        }
    }
    ...
    function mkd_admin_import() {
        if (mkd_core_theme_installed()) {
            ...
            $this->pagehook = add_submenu_page(
                ...
                esc_html__('Mikado Options - Mikado Import', 'medigroup'),                   // The value used to populate the browser's title bar when the menu page is active
                esc_html__('Import', 'medigroup'),                   // The text of the menu in the administrator's sidebar
