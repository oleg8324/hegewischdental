...
require_once 'post-types/portfolio/shortcodes/portfolio-marquee/portfolio-marquee.php';
...
require_once 'post-types/doctors/lib/doctors-query.php';
require_once 'post-types/doctors/doctors-register.php';
require_once 'post-types/doctors/shortcodes/booking-form/booking-form.php';
require_once 'post-types/doctors/shortcodes/booking-form/booking-form-helpers.php';
